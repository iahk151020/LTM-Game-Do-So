...
public class Register extends javax.swing.JPanel {
 ...
 void addListener(ActionListener register) {
        SignupBtn.addActionListener(register); 
    }
    
 
    
    User getRegister() {
        return new User(usernametxt.getText(), passwordtxt.getText(),fullnametxt.getText());
    }
